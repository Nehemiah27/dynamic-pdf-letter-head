...
const QuotationPreview: React.FC<QuotationPreviewProps> = ({ quotation, branding, client, project }) => {
    ...
    <div className="pt-6 mt-auto">
      {branding.footerImage ? (
        <div className="w-full flex flex-col items-center">
          <img src={branding.footerImage} alt="Footer Banner" className="w-full object-contain max-h-24 mb-2" />
          {pageNum && (
  ...
  return (
    <div className="bg-white print:p-0 min-h-screen font-['Inter'] text-slate-800">
      ...
      <div className="p-12 sm:p-16 max-w-4xl mx-auto shadow-sm border border-slate-100 mb-8 print:shadow-none print:border-none print:mb-0 print:p-0 relative page-break min-h-[1120px] flex flex-col">
        ...
        <div className="flex-1 px-4">
          ...
          <div className="mb-2 text-center">
            <h2 className="text-lg font-black border-b-2 border-slate-900 inline-block pb-0.5 px-4">{quotation.introText}</h2>
          </div>
          ...
          <div className="mb-8 text-[12px]">
            ...
            <div className="ml-4 space-y-1">
              ...
              <p className="whitespace-pre-wrap font-medium">{quotation.recipientAddress}</p>
              <p className="pt-6 font-bold text-slate-900">Subject: <span className="font-normal">{quotation.subject}</span></p>
          ...
          <div className="mt-16 text-[12px] ml-4">
            ...
            <div className="space-y-1">
              <p className="font-black text-lg text-[#2E3191]">{quotation.regardsName}</p>
        ...
        <div className="p-12 sm:p-16 max-w-4xl mx-auto shadow-sm border border-slate-100 mb-8 print:shadow-none print:border-none print:mb-0 print:p-0 relative page-break min-h-[1120px] flex flex-col">
          ...
          <div className="flex-1 px-4">
            ...
            <div className="overflow-x-auto">
              <table className="quotation-table w-full border-collapse text-[11px]" style={{ tableLayout: 'fixed' }}>
                <thead>
      ...
      {sections.map((section, idx) => (
        <div key={section.id} id={`section-${section.id}`} className="p-12 sm:p-16 max-w-4xl mx-auto shadow-sm border border-slate-100 mb-8 print:shadow-none print:border-none print:mb-0 print:p-0 relative page-break min-h-[1120px] flex flex-col">
          <HeaderSection />
            ...
            {idx === sections.length - 1 && (
              <div className="mt-16 text-left space-y-8 animate-fade-in pb-12">
                ...
                <div className="pt-10 border-t border-slate-100">
                  <p className="font-bold text-xs mb-3 text-slate-400 uppercase tracking-widest">Thanking you</p>
                  <h4 className="text-base font-black text-[#2E3191] uppercase tracking-tighter">{branding.registry.name}</h4>
