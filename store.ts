...
const createSupplyAndFabSections = (): Section[] => [
  ...
  },
  {
    id: "sf-1c",
    title:
      "1.2 Standard Building Additions (Canopy / Fascia / Liner / Partitions)",
    type: "table",
  ...
  },
  {
    ...
    type: "table",
    headers: ["No.", "Description", "Details"],
    content: "",
    items: [],
    rows: [
      [
  ...
  {
    id: "sf-4",
    title: "4.0 APPLICABLE CODES for Design:",
    type: "list",
    content: "",
    headers: [],
    rows: [],
  ...
  },
  {
    ...
    type: "table",
    headers: ["SI. No.", "Structural Components", "Details", "Codes"],
    content: "",
    items: [],
    rows: [
      [
  ...
  {
    id: "sf-9",
    title: "10.0 COMMERCIAL TERMS & CONDITIONS",
    type: "table",
    headers: ["Sl. No.", "Description", "Conditions"],
    content: "",
    items: [],
    rows: [
      [
...
const createStructuralFabSections = (): Section[] => [
  ...
  },
  {
    ...
    title: "Payment Terms",
    type: "list",
    content: "Supply amount:",
    headers: [],
    rows: [],
    items: [
      "1. 15% advance on confirmation of Worder before Labour mobilization.",
      "2. 85% after fabrication Completion",
    ],
  },
  {
    id: "st-3",
...
const DEFAULT_DATA: AppState = {
  ...
  quotations: [createSupplyAndFabricationTemplate("p1", 1)],
